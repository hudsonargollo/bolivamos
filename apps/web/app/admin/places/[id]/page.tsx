      ...
      <form action={updatePlace} className="a-form a-card" style={{ maxWidth: 520 }}>
        ...
        <div className="a-fieldset">
          ...
          <div className="a-field">
            ...
            <textarea id="description" name="description" defaultValue={place.description ?? ""} className="a-input" rows={4} />
          </div>
          <div className="a-field">
            <label htmlFor="address">Address</label>
            <input id="address" name="address" defaultValue={place.address ?? ""} className="a-input" />
          </div>
          <div className="a-field">
            <label htmlFor="googleMapsUrl">Google location URL</label>
            <input id="googleMapsUrl" name="googleMapsUrl" type="url" defaultValue={place.googleMapsUrl ?? ""} className="a-input" />
          </div>
          <div className="a-row-2">
            <div className="a-field">
              <label htmlFor="websiteUrl">Website / menu URL</label>
              <input id="websiteUrl" name="websiteUrl" type="url" defaultValue={place.websiteUrl ?? ""} className="a-input" />
            </div>
            <div className="a-field">
