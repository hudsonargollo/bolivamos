...
<header class="hero-header">
  <a class="wordmark logo-wordmark" href="#" aria-label="BoliVibes home"><img src="/api/assets/brand/bolivibes-logo.webp" alt="BoliVibes" /></a>
  <nav class="clay-nav">
...
<div class="info-pop" id="infoPop" aria-label="Mapa">
  ...
  <a href="/city3d" id="openRealMapLink" class="clay-btn" style="display:block;text-align:center;margin-top:12px;text-decoration:none;" data-i18n="openRealMap">Abrir mapa real →</a>
</div>
