...
window.addEventListener('bolivamos-lang', renderPlaces);
  ...
  const I18N = {
    en: { week: 'This week', weekend: 'This weekend', nightlife: 'Nightlife', explore: 'Explore the city', places: 'Places', todo: 'Things to do', list: 'List an event', login: 'Log in', live: 'Live', map: 'Map', tonightTitle: 'Live tonight', tonightSub: 'Happening in Santa Cruz after dark', viewList: 'List', viewMini: 'Miniatures',
    ...
    es: { week: 'Esta semana', weekend: 'Este finde', nightlife: 'Vida nocturna', explore: 'Explora la ciudad', places: 'Lugares', todo: 'Qu\u00e9 hacer', list: 'Publica tu evento', login: 'Iniciar sesi\u00f3n', live: 'En vivo', map: 'Mapa', tonightTitle: 'En vivo esta noche', tonightSub: 'Lo que pasa en Santa Cruz al caer la noche', viewList: 'Lista', viewMini: 'Miniaturas',
